...
public class AUBankLoanReapyment extends TestBase {

	public AUBankLoanReapyment() {
	...
	@FindBy(xpath = "//div[@id='Loan-Number-error-msg']")
	...
	public boolean billAvailablepayBill() throws Throwable {
		...
		if (billAvailable == true) {
			...
			} else if (error_msg.equals("Please enter valid 12-16 digit numeric Loan Number")) {
